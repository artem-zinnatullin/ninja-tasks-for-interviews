...
public class NetworkRequest {
     ...
     * @param postBody could be null if you want to send GET request
     * @throws NetworkException if url format is incorrect
     */
    ...
    public static NetworkRequest getRequest(String url) throws NetworkException {
        return new NetworkRequest(url, Method.GET, null);
    }

    public static NetworkRequest postRequest(String url, String postBody) throws NetworkException {
    ...
    public NetworkRequest setConnectionTimeoutInMillis(int connectionTimeoutInMillis) {
    ...
    public NetworkRequest setGzipCompressionEnabled(boolean gzipCompressionEnabled) {
    ...
    public NetworkRequest setQueryRetryLimit(int queryRetryLimit) {
